...
load("//tf/core/cdktf:cdktf_common.bzl", "create_cdktf_json", "create_go_mod", "create_build_bazel", "get_environment_for_cdktf")
...
def _cdktf_bindings_repository_gazelle_impl(repository_ctx):
    ...
    script_label = Label("//tf/utilities/scripts:generate_cdktf.sh")
    ...
    fix_script_label = Label("//tf/utilities/scripts:fix_imports.sh")

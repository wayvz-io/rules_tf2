...
tf_validate_test = rule(
    ...
    attrs = {
        ...
        "_terraform_wrapper_script": attr.label(
            default = "//tf/execution/scripts:terraform_wrapper.sh",
            allow_single_file = True,
        ),
        "_copy_module_files_script": attr.label(
            default = "//tf/execution/scripts:copy_module_files.sh",
            allow_single_file = True,
        ),
        "_copy_source_files_script": attr.label(
            default = "//tf/execution/scripts:copy_source_files.sh",
            allow_single_file = True,
        ),
        "_terraform_init_script": attr.label(
            default = "//tf/execution/scripts:terraform_init.sh",
            allow_single_file = True,
        ),
    },
    test = True,

...
load("//tf/core/rules:info.bzl", "TfProviderConfigurationsInfo", "TfProviderMirrorInfo", "TfProviderAliasInfo", "TfModuleInfo")
load("//tf/utilities/utils:runfiles.bzl", "get_runfiles_dir_script", "get_workspace_dir_script", "create_runfiles_path")

...
def _create_mock_registry_impl(ctx):
    ...
    registry_dir = ctx.actions.declare_directory("provider_registry")
    
    ctx.actions.run_shell(
        outputs = [registry_dir],
        command = """
            mkdir -p $1/registry.terraform.io/hashicorp/aws/6.12.0/linux_amd64
            echo "mock provider" > $1/registry.terraform.io/hashicorp/aws/6.12.0/linux_amd64/terraform-provider-aws_v6.12.0
        """,

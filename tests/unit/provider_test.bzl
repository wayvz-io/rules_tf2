...
load("//tf/core/providers:provider_mirror.bzl", "provider_mirror")
load("//tf/core/providers:filesystem_mirror.bzl", "filesystem_mirror")
load("//tf/core/rules:info.bzl", "TfProviderConfigurationsInfo")

...
load("//tf/core/rules:info.bzl", "TfModuleInfo", "TfProviderConfigurationsInfo")
...
def module_test_suite(name):
    ...
    # Note: Nested module tests removed due to file generation conflicts
    # When tf_module_rule has modules, it rewrites source files in-place,
    # which conflicts with genrule-generated files

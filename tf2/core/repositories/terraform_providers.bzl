...
def _terraform_providers_impl(ctx):
    ...
    build_content = [
        ...
        '',
        'load("@rules_tf2//tf2/core/providers:provider_download_action.bzl", "provider_download_action")',
        'load("@rules_tf2//tf2/core/providers:provider_alias_simple.bzl", "provider_alias_simple")',
        'load("@rules_tf2//tf2/core/providers:filesystem_mirror.bzl", "filesystem_mirror")',
        '',
